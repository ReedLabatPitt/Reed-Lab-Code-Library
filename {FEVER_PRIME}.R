...
################################
animal_number <- "MPrimeTest2.xlsx"
################################
...
Label2 <- list("Max Temp","Max Residual","Duration","Fever-Hours")
Label3 <- list("Min Temp","Min Residual","Hypothermia Duration","Hypothermia Hours")
...
writeData(wb, "Sheet1", HypothermDuration, startCol = 10, startRow = 11)
writeData(wb, "Sheet1", HypoThermHours, startCol = 11, startRow = 11)
